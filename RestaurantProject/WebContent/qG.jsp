...
<% session = request.getSession(false);
	...
	if(key !=null){%>	
<jsp:useBean id="qgbean"  class="dbbeans.QGBean" scope="session" />
<html lang="en">
	<head>
	...
	<body>
		<div class="wrapper">
			...
			<h2>
				QG. Restaurant's not rated in<br>
				<jsp:getProperty name="qgbean" property="date"/>
			</h2>
			<table  class="table2" border=1>
				...
				<jsp:getProperty name="qgbean" property="qgList" />
			</table>
		</div>
		<div class="footer">
